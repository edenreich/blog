  ...
  render(): JSX.Element {
    return (
      <li>
        ...
        <div className={`${styles.progressbar} ${styles.line} ${styles.border} ${this.props.color}`} data-value={this.props.progress}>
          ...
          <div className={styles['progressbar-text']} style={{ color: 'inherit', position: 'absolute', right: 0, top: '-30px', padding: 0, margin: 0 }}>{this.props.progress} %</div>
        </div>
      </li>
    );
  }
